...
f_01 = np.load('Aayush.npy').reshape((20, 50*50*3)) # Aayush
f_02 = np.load('Sehej.npy').reshape((20, 50*50*3)) # Sehej
...
labels[:20, :] = 0.0    # first 20 for Aayush (0)
labels[20:40, :] = 1.0  # next 40 for Sehej (1)
